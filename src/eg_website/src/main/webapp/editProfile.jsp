...
<html>
    ...
    <head>
        ...
        <div id="updateProfile">
            ...
            <form id="updateForm" method="POST"  action="/Profile/<%=ud.getUsername()%>" >
                <ul>
                    ...
                    <li><label class="input">Mobile</label><input type="text" name="street" value="<%=up.getMobile()%>"></li>
                    <li><label class="input">Contact Number</label><input type="text" name="street" value="<%=up.getContactNumber()%>"></li>
                    
                    <li><label class="input">Matric Number </label><input type="text" name="street" value="<%=up.getMatricNumber()%>"></li>
