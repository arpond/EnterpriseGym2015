...
<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/eg_website/Admin">John Smith (Admin)</a>
            </div>
            <!-- Top Menu Items -->
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>Added student's details to their profile</p>
                                    </div>
                                </div>
                            </a>
                        </li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li> <a href="/eg_website/Admin"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a> </li>
